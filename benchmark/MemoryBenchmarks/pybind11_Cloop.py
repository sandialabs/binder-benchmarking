...
import numpy as np
from pyennui_pybind11.mechanization.ecef import propagation_test as pybind11_repeated_propagation #implementation that loops on C side.
...
def main():
    ...
    warmup_base(warmup_cycles,pybind11_C_loop)
    timeit.timeit(pybind11_C_loop,number=benchmark_cycles)
